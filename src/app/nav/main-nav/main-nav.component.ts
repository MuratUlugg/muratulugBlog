...
export class MainNavComponent implements OnInit {
  ...
  pageActive : MainPage;
  constructor( private router:Router) //Router adında bir router tanımladık.Yapılacak işlem routerdaki her değişikliği takip etmek.
  {
  this.router.events.subscribe(x=>{
    if (x instanceof NavigationEnd) // x  navigasyonun bittiği değişken ise
    {
      if(x.url.indexOf("home") > 0) // url home ise
      {
